export default {
  ...
  settings: {
    ...
    libraryDownload: 'Télécharger le guide complet PDF',
    libraryPremiumOnly: 'Ta bibliothèque est réservée aux abonnés Premium.',
    libraryDiscoverPremium: 'Découvrir Premium',
    libraryFullAccessBadge: 'Accès complet',
    libraryTrialBadge: 'Essai en cours',
    libraryFreeBadge: 'Gratuit',
    libraryNewChapter: 'Nouveau · Premium',
    libraryLockedFree: 'Passe à Premium pour accéder à ce chapitre.',
    libraryLockedTrial: 'Ce chapitre sera automatiquement débloqué à la confirmation de votre abonnement annuel.',
    libraryCountdown: 'Débloqué dans {{days}} jour(s)',
    libraryStartTrial: 'Démarrer l\'essai gratuit 7 jours',
    ...
    contactEmailSubject: '[Owoda] Retour utilisateur',
    contactEmailBody: "Bonjour,\n\nVersion de l'app : {{version}}\nAppareil : {{device}}\n\nMon retour :\n",
    contactNoApp: 'Contactez-nous à hello@owodalabs.com',
  },
  ...
  premium: {
    ...
    annualBilling: 'Annulable à tout moment.',
