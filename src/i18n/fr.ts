export default {
  ...
  settings: {
    ...
    libraryGuideBadge: '17 pages · PDF',
    ...
    libraryLockedBadge: 'Premium',
    libraryLockedFree: 'Le guide complet se débloque dès ton premier paiement, à la fin de l\'essai.',
    libraryStartTrial: 'Passer à Premium',
  ...
  premium: {
    ...
    trialDisclosure: 'Essai gratuit 7 jours, puis {{price}}/an. Renouvellement automatique.',
    ...
    features: {
      ...
      guide: 'Guide Pratique Owoda — 17 pages',
    },
    comp: {
      headerFree: 'GRATUIT',
