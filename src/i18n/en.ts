export default {
  ...
  settings: {
    ...
    libraryLockedFree: 'The complete guide unlocks after your first payment, at the end of the trial.',
    libraryStartTrial: 'Upgrade to Premium',
  ...
  premium: {
    ...
    unlockSubtitle: 'CSV export, dashboard and more',
    ...
    trialDisclosure: '7-day free trial, then {{price}}/year. Automatic renewal.',
